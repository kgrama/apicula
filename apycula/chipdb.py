...
# Static PLL base/power-up configuration: every fuse the closed flow sets for
# ANY placed PLL beyond the characterized div/odiv/enable fields (measured as
# gwsh_ref pll138_pll minus pll138_nopll minus the characterized row-21
# fields). Without these the PLL block never powers up (no LOCK) - found on
# silicon via pll_blink 'P0'.
_BPLL_BASE_BITS = [
